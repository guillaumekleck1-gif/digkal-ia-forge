        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center items-center gap-12">
            ...
            <div className="text-center">
              <a href="https://certifopac.fr/qualiopi/certification/verification/?siren=984322198#webApp" target="_blank" rel="noopener noreferrer" className="bg-white p-4 shadow-sm inline-block hover:shadow-md transition-shadow px-[16px] py-[16px]">
